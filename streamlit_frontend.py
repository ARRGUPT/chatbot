...
# create a session_state (maintaining the conversational history)
...
if user_message:
    ...
    # first add the user_message to message_history then show
    ...
    # first add the ai_message to message_history then show
                ...
                if 'chat_node' in chunk:
                    ...
                    for message_chunk in messages:
                        ...
                        if isinstance(message_chunk, AIMessage):
                            ...
                            response_holder["text"] += chunk_content
                            yield chunk_content
